...
const Signup = () => {
    ...
    const [profile, setPrtofile] = useState()


    const handleRegister = async (e) => {
        if (email && password && fullName && phone && adderess) {
            await createUserWithEmailAndPassword(auth, email, password)
                .then(async () => {
                    const storageRef = ref(storage, `profiles/${profile.name + Math.random()}`)
                    await uploadBytes(storageRef, profile).then(async () => {
            ...
            alert("something went missing, fill proprely  ")
        }
    }
                    ...
                    <div
                        ...
                        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                            <form>
                                ...
                                <div class="relative mb-6 shadow-md" data-te-input-wrapper-init>
                                    <input
                                        type="text"
                                ...
                                <div class="relative mb-6 shadow-lg" data-te-input-wrapper-init>
                                    <input
                                ...
                                <div class="relative mb-6 shadow-lg" data-te-input-wrapper-init>
                                    ...
                                    <input onChange={e => setPrtofile(e.target.files[0])} class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" />
                                </div>
                                ...
                                <div class="mb-6 flex items-center justify-between">
                                    ...
                                    <a href="#!" className='decoration-inherit text-blue-700'>Forgot password?</a>
                                </div>
